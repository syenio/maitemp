  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(data.error || 'Failed to create slide');
      }
    } catch (error) {
                ...
                <div>
                  ...
                  {slideData.imageUrl && (
                    <div className="mt-4">
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-1">Background Image URL: {slideData.imageUrl}</p>
                    </div>
                  )}
                </div>

                {/* Background Image URL Input (Alternative) */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    You can upload an image above or paste a direct URL here
                  </p>
                </div>
              </CardContent>
            </Card>
